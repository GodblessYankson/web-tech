  ...
  return (
    <footer className="footer-container">
      <div className="footer-link-container">
        ...
        <div className="footer-social-icon">
          <ul>
            <li>
              <a
                href="https://www.facebook.com/profile.php?id=100072657574447"
            ...
            <li>
              <a
                href="https://www.instagram.com/yanksongodbless?igsh=OGQ5ZDc2ODk2ZA=="
                className="navbar-content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://twitter.com/YanksonGod9922"
                className="navbar-content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/godbless-yankson-aa5838271/"
                className="navbar-content"
                target="_blank"
                rel="noreferrer"
              >
      ...
      <div className="footer-content-container">
        <p className="footer-content">💖C💖D💖K💖</p>
        <div className="footer-social-icon">
          <ul>
            <li>
              <Link
